## Matrix inversion is usually a costly computation (depending on the factors like dimensions of the matrix).
## The functions below aim to avoid re-computation of the inverse for the same matrix through caching.
